...
// Fecha actualización: 03/09/2026
// Dev: Ing. Jimmy Wladimir Cabrera Soto
// Code: app_sata_two_orbits_v5.js
// Legacy: app_sata_two_orbits_v4.js
// =====================================================================================
/* ======================= PARÁMETROS DE ANÁLISIS ======================= */
// 1.- Imports
var zona = ee.FeatureCollection("users/ecuadorbfast/SATAASSEST/cuadrantes_monitoreo_V2");
var bos2024 = ee.Image("projects/snmbdevs/assets/mascara_bosques_2024_ctn2");
...
function processInBatches() {
    ...
    for (var i = 0; i < PROCESS_ZONE; i += batchSize) {
        ...
        batch.forEach(function(key) {
            ...
            var bosque2024 = bos2024.clip(table);
            
            ///--- Multiplicar los cambios detectados por la máscara de bosques ---///
            var cambiosbosques = (cambios.multiply(bosque2024).int32());
    ...
    Map.addLayer(bos2024,{min:0.0, max:1.0,palette:['229512']},'Máscara bosques 2024', 0);
