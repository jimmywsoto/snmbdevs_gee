...
Map.addLayer(desc_date1, {min: -25, max: 5}, 'Órbita descendente Periodo 1', 0);
Map.addLayer(desc_date2, {min: -25, max: 5}, 'Órbita descendente Periodo 2', 0);
...
Export.image.toDrive({
  image: asc_desc,
  description: 'RGB_Sentinel1_Descendente',
  scale: 10,
  maxPixels:1e13,
  region: table,
});
...
Export.table.toDrive({
  ...
  description: 'fechas_desc_50-51-52_'+fecha4,
  fileFormat: "CSV",
  selectors: ['dn','date']
});
...
Export.image.toDrive({
   ...
   description: 'cambios_manglares_VH_desc_50-51-52_'+fecha4,
   scale: 10,
   region: table,
   fileFormat: 'GeoTIFF',
   maxPixels: 1E13
